    ...
    rdf_catalog = (
        "http://registration-api:8080/catalogs/911259583",
        {
            ...
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#type": [
                {"type": "uri", "value": "http://www.w3.org/ns/dcat#Catalog"}
            ],
...
def test_catalog_reference_with_datasets():
    ...
    assert (
        "http://brreg.no/catalogs/910244132/datasets/ebd0aa41-da69-4f37-a44a-2d10f127a68a"
        in result.datasets
    )
    assert (
        "http://brreg.no/catalogs/910244132/datasets/3749f2c6-0d16-4bfb-b74f-6597b3705e2e"
        in result.datasets
    )
    assert (
        "http://brreg.no/catalogs/910244132/datasets/c6b9e443-12a4-4d29-854a-0f6eda682858"
        in result.datasets
    )
    assert (
        "http://brreg.no/catalogs/910244132/datasets/a4c9556f-9874-400b-80ad-7cd74cfb3c23"
        in result.datasets
    )
...
def test_catalog_reference_eq_on_catalog_record_entry():
    ...
    ref_records = [
        ...
        CatalogRecords(record_entry=mock_records[1]),
    ]
    result = CatalogReference(catalog_entry=rdf_catalog, catalog_records=ref_records)
    assert len(result.record_refs) == 1
    assert (
        result
        == "https://datasets.staging.fellesdatakatalog.digdir.no/catalogs/c554d078-c583-395d-b7c1"
        "-950a1f287c33 "
    )
...
def test_reference_mapper_for_catalogs(empty_open_licence_b_nodes_patch):
    ...
    assert (
        result.get_dataset_catalog_name(
            dataset_node_uri="http://brreg.no/catalogs/910244132/datasets/85875858585858a"
        )
        == "Datakatalog for VÅLER I ØSTFOLD OG VIKHAMMER"
    )
    assert (
        result.get_dataset_catalog_name(
            record_part_of_uri="http://registration-api:8080/catalogs/876543231"
        )
        == "Datakatalog without dcat dataset"
    )
    assert (
        result.get_dataset_catalog_name(
            dataset_node_uri="http://brreg.no/catalogs/910244132/datasets/3749f2c6-0d16-4bfb-b74f-6597b3705e2e"
        )
        == "Datakatalog with dcat dataset"
    )
    assert (
        result.get_dataset_catalog_name(
            "http://brreg.no/catalogs/910244132/datasets/3749f2c6-0d16-4bfbnotinlist3705e2e"
        )
        is None
    )
...
def test_get_record_for_dataset(empty_open_licence_b_nodes_patch):
    ...
    result = mapper.get_catalog_record_for_dataset(
        dataset_uri="https://data.norge.no/node/1589"
    )
    result_keys = result.keys()
    assert JsonRDF.dct.issued in result_keys
    assert JsonRDF.dct.isPartOf in result_keys
    assert JsonRDF.foaf.primaryTopic in result_keys
    assert (
        result[JsonRDF.dct.isPartOf][0][ContentKeys.VALUE]
        == "https://datasets.staging.fellesdatakatalog.digdir.no/catalogs/a4153a19-50f9-332b-b7ae-fe3273cbada7"
    )
    assert (
        result[JsonRDF.foaf.primaryTopic][0][ContentKeys.VALUE]
        == "https://data.norge.no/node/1589"
    )
    assert (
        result[JsonRDF.dct.issued][0][ContentKeys.VALUE] == "2020-08-19T09:39:29.822Z"
    )
    exp_no_result = mapper.get_catalog_record_for_dataset(
        dataset_uri="https://data.norge.no/node/99887766"
    )
...
mock_records = [
    (
        "https://datasets.staging.fellesdatakatalog.digdir.no/datasets/b827ea5e-912a-362a-abfc-ba06fe1cb77f",
        {
            "http://purl.org/dc/terms/issued": [
                {
                    "type": "literal",
                    "value": "2020-08-19T09:39:29.822Z",
                    "datatype": "http://www.w3.org/2001/XMLSchema#dateTime",
                }
            ],
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#type": [
            ...
            "http://xmlns.com/foaf/0.1/primaryTopic": [
                {"type": "uri", "value": "https://data.norge.no/node/1589"}
            ],
            "http://purl.org/dc/terms/modified": [
                {
                    "type": "literal",
            ...
            "http://purl.org/dc/terms/identifier": [
                {"type": "literal", "value": "b827ea5e-912a-362a-abfc-ba06fe1cb77f"}
            ],
        },
    ),
    (
        "https://datasets.staging.fellesdatakatalog.digdir.no/datasets/45a5965e-e3a9-32ec-8e99-695017c10140",
        {
            ...
            "http://xmlns.com/foaf/0.1/primaryTopic": [
                {"type": "uri", "value": "https://data.norge.no/node/844"}
            ],
            "http://purl.org/dc/terms/modified": [
                {
                    "type": "literal",
    ...
    (
        "https://datasets.staging.fellesdatakatalog.digdir.no/datasets/76e45d64-b4fc-39a7-a77d-17804d97ac96",
        {
            ...
            "http://xmlns.com/foaf/0.1/primaryTopic": [
                {"type": "uri", "value": "https://data.norge.no/node/3153"}
            ],
            "http://purl.org/dc/terms/modified": [
                {
                    "type": "literal",
    ...
    (
        "https://datasets.staging.fellesdatakatalog.digdir.no/catalogs/c554d078-c583-395d-b7c1-950a1f287c33",
        {
            ...
            "http://purl.org/dc/terms/identifier": [
                {"type": "literal", "value": "c554d078-c583-395d-b7c1-950a1f287c33"}
            ],
        },
    ),
]
mock_datasets = [
    (
        "https://kartkatalog.geonorge.no/Metadata/uuid/5857ec0a-8d2c-4cd8-baa2-0dc54ae213b4",
        {
            "http://purl.org/dc/terms/spatial": [
                {"type": "bnode", "value": "_:b1bc8ab54b2d650fa9998dc6f9670bba"}
            ],
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#type": [
            ...
            "http://www.w3.org/ns/dcat#keyword": [
                ...
                {
                    "type": "literal",
                    "value": "naturmangfoldloven av 2009",
                    "lang": "no",
                },
                {"type": "literal", "value": "Natur", "lang": "no"},
            ...
            "http://purl.org/dc/terms/identifier": [
                {"type": "literal", "value": "5857ec0a-8d2c-4cd8-baa2-0dc54ae213b4"}
            ],
        },
    ),
    (
        "https://kartkatalog.geonorge.no/Metadata/uuid/de19fbbf-3734-47a0-89f5-6c5769071cdd",
        {
            ...
            "http://purl.org/dc/terms/description": [
                {
                    "type": "literal",
                    "value": "Arealstatistikken viser utstrekning (oppgitt i kvadratkilometer) for fylker, "
                    ...
                    "kartdatabasen i målestokk 1:50 000 kalt N50 Kartdata.",
                    "lang": "no",
                }
            ],
            "http://www.w3.org/ns/dcat#keyword": [
                {"type": "literal", "value": "Arealstatistikk", "lang": "no"},
            ...
            "http://purl.org/dc/terms/license": [
                {
                    "type": "uri",
                    "value": "https://creativecommons.org/licenses/by/4.0/deed.no",
                }
            ],
            "http://www.w3.org/ns/dcat#distribution": [
                {
            ...
            "http://purl.org/dc/terms/identifier": [
                {"type": "literal", "value": "ce353b52-910e-404b-8a61-f7805b021bc7"}
            ],
            "http://purl.org/dc/terms/title": [
                {
                    "type": "literal",
                    "value": "Arealstatistikk for Norge 1994 - 2019",
                    "lang": "no",
                }
            ],
        },
    ...
    (
        "https://dataut.vegvesen.no/dataset/60f44321-7899-4c8f-a1d9-db4846409eb7",
        {
            ...
            "http://purl.org/dc/terms/title": [
                {"type": "literal", "value": "Kjøretøyopplysninger", "lang": "nb"}
            ],
            "http://purl.org/dc/terms/identifier": [
                {
                    "type": "literal",
...
mock_distributions = [
    (
        "_:36016e0cbd5e5a436c2317821f2b8c9f",
        {
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#type": [
                {"type": "uri", "value": "http://www.w3.org/ns/dcat#Distribution"}
            ],
            ...
            "http://purl.org/dc/terms/license": [
                {"type": "bnode", "value": "_:7848e2c978fce16057d67bb9e326b13a"}
            ],
        },
    ),
    (
    ...
    (
        "_:faf29c364e4520c1db6af9ce27818a1b",
        {
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#type": [
                {"type": "uri", "value": "http://www.w3.org/ns/dcat#Distribution"}
            ],
            ...
            "http://purl.org/dc/terms/license": [
                {"type": "bnode", "value": "_:86687ee4606f4f64689d40920541fe38"}
            ],
        },
    ),
]
mock_licence_documents = [
    (
        "_:2fb1be20b4b19062bd2425899b157551",
        {
            ...
            "http://www.w3.org/2000/01/rdf-schema#label": [
                {
                    "type": "literal",
                    "value": "barn som ikke har fylt 18 år innen utløpet av skatteleggingsperioden",
                    "lang": "nb",
                }
            ],
        },
    ...
    (
        ...
        {
            "http://purl.org/dc/terms/spatial": [
                {"type": "bnode", "value": "_:f9c14e33ab8f2bd4d6594e8215f0463f"}
            ],
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#type": [
                {"type": "uri", "value": "http://www.w3.org/ns/dcat#Dataset"}
            ],
            ...
            "http://purl.org/dc/terms/title": [
                {
                    "type": "literal",
                    "value": "INSPIRE Administrative units",
                    "lang": "no",
                }
            ],
        },
    ...
    (
        "_:dd7d83d7d3a20af0487d59871f9eb3d5",
        {
            "http://www.w3.org/1999/02/22-rdf-syntax-ns#value": [
                {"type": "literal", "value": "asdasd", "lang": "nb"}
            ]
        },
    ),
    (
...
mock_distribution_b_node_in_dataset = {
    ...
    "http://purl.org/dc/terms/title": [
        {"type": "literal", "value": "Kart over vegnett \u2013 Elveg", "lang": "nb"},
        {"type": "literal", "value": "Map over road networks - Elveg", "lang": "en"},
    ],
}
